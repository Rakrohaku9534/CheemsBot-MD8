...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "false") {
			...
			await XeonBotInc.groupAcceptInvite("-") //auto join group, if group link is invalid or if bot number is not able to join the group, then it will give error in the startup
			//await delay(1000 * 2) 
